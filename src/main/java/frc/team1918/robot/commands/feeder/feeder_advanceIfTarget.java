 ...
 * A command that ...
 */
public class feeder_advanceIfTarget extends CommandBase {
   ...
   */
  public feeder_advanceIfTarget(FeederSubsystem feeder, VisionSubsystem vision) {
    m_feeder = feeder;
    m_vision = vision;
  ...
  public void initialize() {
    ...
    if(m_vision.isTargetAcquired()) m_feeder.runFeeder(true);
