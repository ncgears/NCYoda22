...
public class cg_auton_AL3TwoBall extends SequentialCommandGroup {
  ...
  public cg_auton_AL3TwoBall(DriveSubsystem drive, CollectorSubsystem collector, FeederSubsystem feeder, ShooterSubsystem shooter, VisionSubsystem vision) {
    ...
    addCommands(
        ...
        new WaitCommand(2.0), //give time for shot
        new shooter_stopShooter(m_shooter),
        new shooter_hoodDown(m_shooter),
        new feeder_stop(m_feeder),
        new collector_intakeStop(m_collector),
