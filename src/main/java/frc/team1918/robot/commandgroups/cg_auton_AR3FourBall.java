...
public class cg_auton_AR3FourBall extends SequentialCommandGroup {
  ...
  public cg_auton_AR3FourBall(DriveSubsystem drive, CollectorSubsystem collector, FeederSubsystem feeder, ShooterSubsystem shooter, VisionSubsystem vision) {
