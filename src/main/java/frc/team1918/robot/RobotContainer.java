...
public class RobotContainer {
  ...
  //button definitions
    //Driver Controller
      ...
      private POVButton btn_MUSIC_PLAY = new POVButton (dj, Constants.OI.Driver.DPAD_MUSIC_PLAY);
      private POVButton btn_MUSIC_STOP = new POVButton (dj, Constants.OI.Driver.DPAD_MUSIC_STOP);
