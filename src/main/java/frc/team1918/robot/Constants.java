...
public class Constants {
    ...
    public static final class Auton {
        ...
        public static final String autonToRun = "auton_BasicDriveAuto"; //4BallAuto, BasicDriveAuto, BasicShootingAuto, None //Name of the auton to run (these are in the bottom of RobotContainer)
