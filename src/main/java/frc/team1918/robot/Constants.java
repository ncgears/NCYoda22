...
public class Constants {
    ...
    public static final class Air {
        ...
        public static final int id_ClimbHook1Solonoid = 2; //ID of solonoid for climber hook 1
        public static final int id_ClimbHook2Solonoid = 3; //ID of solonoid for climber hook 2
        ...
        public static final boolean stateClimbHook1Locked = true; //State of the solonoid when the hook is locked
        public static final boolean stateClimbHook2Locked = true; //State of the solonoid when the hook is locked
